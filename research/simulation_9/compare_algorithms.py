...
def main():
    ...
    if not args.skip_training:
        ...
        # PPO
        try:
            run_ppo_training(args.data_dir, args.ppo_timesteps, save_prefix=models_dir)
        ...
        # DQN
        try:
            run_dqn_training(args.data_dir, args.dqn_episodes, args.device, save_prefix=models_dir)
        except Exception as e:
    ...
    if not args.no_plot:
        ...
        try:
            ...
            dqn_data = visualize_dqn_decisions(args.data_dir, f"{models_dir}/comparison_dqn_best.pth", args.device)
        ...
        try:
            lstm_data = visualize_lstm_decisions(
                args.data_dir, f"{models_dir}/comparison_lstm_dqn_best.pth",
